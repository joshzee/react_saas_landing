  ...
  return (
    <header className="fixed top-0 left-0 z-50 w-full py-10">
      <div className="container flex-h-14 items-center max-lg:px-5">
        ...
        <button className="lg:hidden float-end z-2 size-10 border-2 border-s4/s25 rounded-full flex justify-center items-center">
          <img src="./images/magic.svg" width={25} height={25} alt="magic" />
        </button>
      </div>
    </header>
  );
